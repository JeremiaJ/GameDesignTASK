...
{
	public bool destroyOnAwake = true;			// Whether or not this gameobject should destroyed after a delay, on Awake.
	public float awakeDestroyDelay = 1f;		// The delay for destroying it on Awake.
